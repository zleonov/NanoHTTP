...
public final class HttpClient {
     ...
     * <ul>
     * <li>Proxy: N/A</li>
     * <li>Accept GZip compression in HTTP responses: true</li>
     ...
     * <li>Accept: default (will be set when requests are executed)</li>
     * <li>User-Agent: default (will be set when requests are executed)</li>
     * </ul>
     * 
...
//        /**
//         * Adds a default request header for all requests generated by this {@code HttpClient}.
//         * <p>
...
//         */
//        public Builder addDefaultRequestHeader(final String name, final String value) {
//            if (name == null)
//                throw new NullPointerException("name == null");
//            if (value == null)
//                throw new NullPointerException("value == null");
//
//            requestHeaders.putIfAbsent(name, new ArrayList<>(1));
